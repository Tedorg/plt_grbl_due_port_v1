  ...
  */
  void protocol_init()
  {
    ...
    //  spindle_init();
      ...
      if(fresh_boot == 0)
      {
        recall_current_machine_pos();   // get last known machine position
        fresh_boot = 1;
      }
      ...
      motorsEnabled();  // successful init -- so motors on..
  }
  ...
  // ---------------------------------------------------------------------------------
    ...
    while((c = serial_read()) != SERIAL_NO_DATA) {
      ...
      if ((c == '\n') || (c == '\r')|| (c == '!')) { // End of line reached
        ...
        if (sys.abort) { return -1; } // Bail to calling function upon system abort
