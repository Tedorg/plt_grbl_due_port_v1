...
uint8_t gc_execute_line(char *line)
{
  ...
  { // Loop until no more g-code words in line.
    ...
    case 'G':
      ...
      case 5:
      case 38:
        // Check for G0/1/2/3/38 being called with G10/28/30/92 on same block.  % Bezier Plotter V2
        // * G43.1 is also an axis command but is not explicitly defined this way.
        if (axis_command)
        {
          FAIL(STATUS_GCODE_AXIS_COMMAND_CONFLICT);
    ...
    default:
      ...
      case 'I':
        //PLT_V2 Bezier implementation
        if (gc_block.modal.motion == MOTION_MODE_BEZIER)
        {
          word_bit = WORD_Q;
          gc_block.values.offset_a[X_AXIS] = value;
          break;
        }
        else
        {
      ...
      case 'J':
        ...
        {
          word_bit = WORD_Q;
          gc_block.values.offset_a[Y_AXIS] = value;
          break;
        }
        else
        {
      ...
      case 'P':
        ...
        {
          word_bit = WORD_Q;
          gc_block.values.offset_b[X_AXIS] = value;
          break;
        }
        else
        {
      ...
      case 'Q':
        ...
        {
          word_bit = WORD_Q;
          gc_block.values.offset_b[Y_AXIS] = value;
          break;
        }
        else
        {
      ...
      if (word_bit != WORD_Q)
      { //PLT_V2 Bezier implementation Word q geets set if a G5 is present
...
// [9. Override control ]: Not supported except for a Grbl-only parking motion override control.
  ...
  { // Already set as enabled in parser.
  ...
  default:
    // TODO why does it screw up x y z cvlaues?
