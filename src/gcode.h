...
//Bezier Spline support Plottter v2
#define MOTION_MODE_BEZIER 5  // G5 (bezier splien)
...
#define WORD_Y  11
#define WORD_Z  12
#define WORD_Q  13 //Bezier Spline Plotter v2
...
typedef struct {
  ...
  float p;         // G5 Bezier Offset 2
  float q;      // G5 Bezier Offset 2
  float r;         // Arc radius
