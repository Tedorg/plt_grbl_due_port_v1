...
#include "config.h" // For Arduino IDE compatibility.


#ifdef CPU_MAP_2560_INITIAL // (Arduino Mega 2560) Working @EliteEng
  #warning "CPU_MAP_2560_INITIAL MAPPING SELECTED"
  ...
  #warning "CPU_MAP_2560_RAMPS_BOARD MAPPING SELECTED"
